...
if ($url=="MS1234") {
	...
	$url="https://test.playready.microsoft.com/service/rightsmanager.asmx?cfg=(kid:header,sl:2000,persist:false,contentkey:EjQSNBI0EjQSNBI0EjQSOQ==,\$algId)";
...
$soapAction = @$_SERVER["HTTP_SOAPACTION"]; // if empty then do not insert a header
if($soapAction!="") array_push($reqHeaders, "SOAPAction: ${soapAction}"); // "http://schemas.microsoft.com/DRM/2007/03/protocols/AcquireLicense", "/AcknowledgeLicense"
